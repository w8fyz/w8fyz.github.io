...
const projects = [
    ...
    new Project("Wrapper  Java de l'API Ship24", "wrapper_ship4j.html", ["Wrapper", "Java", "Postman"], "J'ai pendant quelques jours travaillé sur la création d'un wrapper pour l'API de Ship24. L'objectif était de pouvoir utiliser facilement leur API dans un programme Java.")
]
